...
def lattice_modification_generator(lattice, relative_offsets):
...
def main():
    ...
    for n, _ in enumerate(lattice_modification_generator(
        lattice,
        relative_offsets=(-args.magnitude, 0, args.magnitude,),
    )):
